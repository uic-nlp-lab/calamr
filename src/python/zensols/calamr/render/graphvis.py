...
from .. import (
    ComponentAlignmentError, GraphEdge, GraphNode, DocumentGraphNode,
    SentenceGraphAttribute, AmrDocumentNode, SentenceGraphNode,
...
class GraphVisGraphRenderer(GraphRenderer):
    ...
    def _render_to_file(self, context: RenderContext, out_file: Path):
        vstyle: Dict[str, Any] = self.visual_style.attributes
        ...
        try:
            ...
            dg.attr(**vstyle)
            if context.heading is not None:
